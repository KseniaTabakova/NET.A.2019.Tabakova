    ...
    public class Book : IEquatable<Book>, IComparable<Book>, IComparable, IBookFormatter
    {
        ...
        public string ISBN
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBookDataException("Invalid book's ISBN.");
                }
                this.isbn = value;
            }
        }
        ...
        public string Author
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBookDataException("Invalid book's author.");
                }
                this.author = value;
            }
        }
        ...
        public string Title
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBookDataException("Invalid book's title.");
                }
                this.title = value;
            }
        }
        ...
        public string Publisher
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBookDataException("Invalid book's publisher.");
                }
        ...
        public int YearOfPublication
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBookDataException("Invalid book's year of publication.");
                }
        ...
        public int NumberOfPages
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBookDataException("Invalid book's number of pages.");
                }
        ...
        public double Price
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidBookDataException("Invalid book's price.");
                }
                this.price = value;
            }
        }
        ...
        public string ToString(string format)
        {
            ...
            switch (format)
            {
                case "1": return Title + separator + Author;
                case "2": return Title + separator + YearOfPublication + separator + Author + separator + ISBN;
                case "3": return Title + separator + YearOfPublication + separator + NumberOfPages + separator + Author + separator + ISBN + separator + Publisher + separator + Price;
